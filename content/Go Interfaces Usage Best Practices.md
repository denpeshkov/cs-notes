...
Note that interfaces sometimes can be used on the producer side. For example, `io` package exports interfaces because it also needs to export generic-use functions like `io.Copy`:
